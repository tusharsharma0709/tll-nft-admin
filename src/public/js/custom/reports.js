    ...
    var sales_table = $('#sales_report').DataTable({
        ...
        ajax: {
          ...
          data: function (d) {
            ...
            d.search_sale_by_tokenid = $('#search_sale_by_tokenid').val(),
            d.search_sale_by_token_address = $('#search_sale_by_token_address').val(),
            d.search_sale_by_buyer = $('#search_sale_by_buyer').val(),
            d.search_sale_by_seller = $('#search_sale_by_seller').val(),
