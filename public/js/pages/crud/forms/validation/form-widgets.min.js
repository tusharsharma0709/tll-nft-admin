var KTFormWidgetsValidation = function () {
  var e;return { init: function () {
      !function () {
        $("#kt_datepicker").datepicker({ todayHighlight: !0, templates: { leftArrow: '<i class="la la-angle-left"></i>', rightArrow: '<i class="la la-angle-right"></i>' } }).on("changeDate", function (t) {
          e.revalidateField("date");
        }), $("#kt_datetimepicker").datetimepicker({ pickerPosition: "bottom-left", todayHighlight: !0, autoclose: !0, format: "yyyy.mm.dd hh:ii" }), $("#kt_datetimepicker").change(function () {
          e.revalidateField("datetime");
        }), $("#kt_timepicker").timepicker({ minuteStep: 1, showSeconds: !0, showMeridian: !0 }), $("#kt_timepicker").change(function () {
          e.revalidateField("time");
        }), $("#kt_daterangepicker").daterangepicker({ buttonClasses: " btn", applyClass: "btn-primary", cancelClass: "btn-light-primary" }, function (t, a, i) {
