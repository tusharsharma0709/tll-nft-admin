...
var KTCkeditorDocument = function () {
    // Private functions
    var demos = function () {
        DecoupledEditor.create(document.querySelector('#kt-ckeditor-1')).then(editor => {
        ...
        DecoupledEditor.create(document.querySelector('#kt-ckeditor-2')).then(editor => {
        ...
        DecoupledEditor.create(document.querySelector('#kt-ckeditor-3')).then(editor => {
