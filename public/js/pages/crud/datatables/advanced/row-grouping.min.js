"use strict";
var KTDatatablesAdvancedRowGrouping = { init: function () {
    $("#kt_datatable").DataTable({ responsive: !0, pageLength: 25, order: [[2, "asc"]], drawCallback: function (t) {
        var a = this.api(),
            l = a.rows({ page: "current" }).nodes(),
            e = null;a.column(2, { page: "current" }).data().each(function (t, a) {
          e !== t && ($(l).eq(a).before('<tr class="group"><td colspan="10">' + t + "</td></tr>"), e = t);
        });
      }, columnDefs: [{ targets: [0, 2], visible: !1 }, { targets: -1, title: "Actions", orderable: !1, render: function (t, a, l, e) {
