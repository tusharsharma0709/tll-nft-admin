"use strict";
var KTDatatablesBasicBasic = { init: function () {
    var t;(t = $("#kt_datatable")).DataTable({ responsive: !0, dom: "<'row'<'col-sm-12'tr>>\n\t\t\t<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>", lengthMenu: [5, 10, 25, 50], pageLength: 10, language: { lengthMenu: "Display _MENU_" }, order: [[1, "desc"]], headerCallback: function (t, a, l, s, e) {
        t.getElementsByTagName("th")[0].innerHTML = '\n                    <label class="checkbox checkbox-single">\n                        <input type="checkbox" value="" class="group-checkable"/>\n                        <span></span>\n                    </label>';
      }, columnDefs: [{ targets: 0, width: "30px", className: "dt-left", orderable: !1, render: function (t, a, l, s) {
          ...
          var e = { 1: { title: "Pending", class: "label-light-success" }, 2: { title: "Delivered", class: " label-light-danger" }, 3: { title: "Canceled", class: " label-light-primary" }, 4: { title: "Success", class: " label-light-success" }, 5: { title: "Info", class: " label-light-info" }, 6: { title: "Danger", class: " label-light-danger" }, 7: { title: "Warning", class: " label-light-warning" } };return void 0 === e[t] ? t : '<span class="label label-lg font-weight-bold' + e[t].class + ' label-inline">' + e[t].title + "</span>";
        } }, { targets: 9, width: "75px", render: function (t, a, l, s) {
          var e = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "success" } };return void 0 === e[t] ? t : '<span class="label label-' + e[t].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + e[t].state + '">' + e[t].title + "</span>";
        } }] }), t.on("change", ".group-checkable", function () {
      var t = $(this).closest("table").find("td:first-child .checkable"),
          a = $(this).is(":checked");$(t).each(function () {
        a ? ($(this).prop("checked", !0), $(this).closest("tr").addClass("active")) : ($(this).prop("checked", !1), $(this).closest("tr").removeClass("active"));
      });
    }), t.on("change", "tbody tr .checkbox", function () {
      $(this).parents("tr").toggleClass("active");
    }), function () {
      var t = $("#kt_datatable_2");t.DataTable({ responsive: !0, dom: "<'row'<'col-sm-12'tr>>\n\t\t\t<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>", lengthMenu: [5, 10, 25, 50], pageLength: 10, language: { lengthMenu: "Display _MENU_" }, order: [[1, "desc"]], headerCallback: function (t, a, l, s, e) {
          t.getElementsByTagName("th")[0].innerHTML = '\n                    <label class="checkbox checkbox-single">\n                        <input type="checkbox" value="" class="group-checkable"/>\n                        <span></span>\n                    </label>';
        }, columnDefs: [{ targets: 0, width: "30px", className: "dt-left", orderable: !1, render: function (t, a, l, s) {
            return '\n                        <label class="checkbox checkbox-single">\n                            <input type="checkbox" value="" class="checkable"/>\n                            <span></span>\n                        </label>';
          } }, { targets: -1, title: "Actions", orderable: !1, width: "125px", render: function (t, a, l, s) {
