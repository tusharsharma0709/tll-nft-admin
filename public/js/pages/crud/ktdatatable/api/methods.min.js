"use strict";
var KTDefaultDatatableDemo = { init: function () {
    var t, a;t = { data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 20, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !0, height: 550, footer: !1 }, sortable: !0, pagination: !0, search: { input: $("#kt_datatable_search_query"), key: "generalSearch" }, columns: [{ field: "RecordID", title: "#", sortable: !1, width: 30, type: "number", selector: { class: "kt-checkbox--solid" }, textAlign: "center" }, { field: "ID", title: "ID", width: 30, type: "number", template: function (t) {
          return t.RecordID;
        } }, { field: "OrderID", title: "Order ID" }, { field: "Country", title: "Country", template: function (t) {
        ...
        } }] }, a = $("#kt_datatable").KTDatatable(t), $("#kt_datatable_destroy").on("click", function () {
      ...
      if (a.rows(".datatable-row-active"), a.nodes().length > 0) {
        var t = a.columns("CompanyName").nodes().text();console.log(t);
      }
    }), $("#kt_datatable_check").on("click", function () {
      var t = $("#kt_datatable_check_input").val();a.setActive(t);
