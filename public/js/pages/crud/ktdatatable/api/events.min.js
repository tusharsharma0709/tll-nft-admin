...
var KTDefaultDatatableDemo = function () {
  var t = function (t) {
    var a = $("#kt_datatable_console").append(t + "\t\n");$(a).scrollTop(a[0].scrollHeight - $(a).height());
      ...
      }), $("#kt_datatable_search_status, #kt_datatable_search_type").selectpicker(), $("#kt_datatable").on("datatable-on-init", function () {
        t("Datatable init");
      ...
      }).on("datatable-on-ajax-fail", function (a, e) {
        t("Ajax error");
      }).on("datatable-on-goto-page", function (a, e) {
        t("Goto to pagination: " + e.page);
      }).on("datatable-on-update-perpage", function (a, e) {
        t("Update page size: " + e.perpage);
      }).on("datatable-on-reloaded", function (a) {
        t("Datatable reloaded");
      }).on("datatable-on-check", function (a, e) {
        t("Checkbox active: " + e.toString());
      }).on("datatable-on-uncheck", function (a, e) {
        t("Checkbox inactive: " + e.toString());
      }).on("datatable-on-sort", function (a, e) {
