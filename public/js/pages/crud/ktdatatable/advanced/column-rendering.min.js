...
var KTDatatableColumnRenderingDemo = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, search: { input: $("#kt_datatable_search_query"), delay: 400, key: "generalSearch" }, columns: [{ field: "RecordID", title: "#", sortable: "asc", width: 40, type: "number", selector: !1, textAlign: "center" }, { field: "OrderID", title: "Customer", width: 250, template: function (t) {
          ...
          var a = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "success" } };return '<span class="label font-weight-bold label-lg label-' + a[t.Type].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + a[t.Type].state + '">' + a[t.Type].title + "</span>";
