...
var KTDatatableRecordSelectionDemo = function () {
  var t = { data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, columns: [{ field: "RecordID", title: "#", sortable: !1, width: 20, selector: { class: "" }, textAlign: "center" }, { field: "OrderID", title: "Order ID", template: "{{OrderID}}" }, { field: "Country", title: "Country", template: function (t) {
        return t.Country + " " + t.ShipCountry;
      } }, { field: "ShipAddress", title: "Ship Address" }, { field: "ShipDate", title: "Ship Date", type: "date", format: "MM/DD/YYYY" }, { field: "Status", title: "Status", template: function (t) {
        var e = { 1: { title: "Pending", class: "label-light-primary" }, 2: { title: "Delivered", class: " label-light-danger" }, 3: { title: "Canceled", class: " label-light-primary" }, 4: { title: "Success", class: " label-light-success" }, 5: { title: "Info", class: " label-light-info" }, 6: { title: "Danger", class: " label-light-danger" }, 7: { title: "Warning", class: " label-light-warning" } };return '<span class="label label-lg font-weight-bold' + e[t.Status].class + ' label-inline">' + e[t.Status].title + "</span>";
      } }, { field: "Type", title: "Type", autoHide: !1, template: function (t) {
        var e = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "success" } };return '<span class="label label-' + e[t.Type].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + e[t.Type].state + '">' + e[t.Type].title + "</span>";
      } }, { field: "Actions", title: "Actions", sortable: !1, width: 125, overflow: "visible", textAlign: "left", autoHide: !1, template: function () {
      ...
      !function () {
        t.extensions = { checkbox: !0 }, t.search = { input: $("#kt_datatable_search_query"), key: "generalSearch" };var e = $("#kt_datatable").KTDatatable(t);$("#kt_datatable_search_status").on("change", function () {
          e.search($(this).val().toLowerCase(), "Status");
        }), $("#kt_datatable_search_type").on("change", function () {
          e.search($(this).val().toLowerCase(), "Type");
        }), $("#kt_datatable_search_status, #kt_datatable_search_type").selectpicker(), e.on("datatable-on-check datatable-on-uncheck", function (t) {
          var a = e.rows(".datatable-row-active").nodes().length;$("#kt_datatable_selected_records").html(a), a > 0 ? $("#kt_datatable_group_action_form").collapse("show") : $("#kt_datatable_group_action_form").collapse("hide");
        }), $("#kt_datatable_fetch_modal").on("show.bs.modal", function (t) {
          var a = e.rows(".datatable-row-active").nodes().find('.checkbox > [type="checkbox"]').map(function (t, e) {
            return $(e).val();
          });console.log(a);for (var l = document.createDocumentFragment(), n = 0; n < a.length; n++) {
            var s = document.createElement("li");s.setAttribute("data-id", a[n]), s.innerHTML = "Selected record ID: " + a[n], l.appendChild(s);
          }$("#kt_datatable_fetch_display").append(l);
        }).on("hide.bs.modal", function (t) {
          $("#kt_datatable_fetch_display").empty();
        });
      }(), function () {
        t.extensions = { checkbox: !0 }, t.search = { input: $("#kt_datatable_search_query_2"), key: "generalSearch" };var e = $("#kt_datatable_2").KTDatatable(t);$("#kt_datatable_search_status_2").on("change", function () {
          e.search($(this).val().toLowerCase(), "Status");
        }), $("#kt_datatable_search_type_2").on("change", function () {
          e.search($(this).val().toLowerCase(), "Type");
        }), $("#kt_datatable_search_status_2, #kt_datatable_search_type_2").selectpicker(), e.on("datatable-on-click-checkbox", function (t) {
          var a = e.checkbox().getSelectedId().length;$("#kt_datatable_selected_records_2").html(a), a > 0 ? $("#kt_datatable_group_action_form_2").collapse("show") : $("#kt_datatable_group_action_form_2").collapse("hide");
        }), $("#kt_datatable_fetch_modal_2").on("show.bs.modal", function (t) {
          for (var a = e.checkbox().getSelectedId(), l = document.createDocumentFragment(), n = 0; n < a.length; n++) {
            var s = document.createElement("li");s.setAttribute("data-id", a[n]), s.innerHTML = "Selected record ID: " + a[n], l.appendChild(s);
          }$("#kt_datatable_fetch_display_2").append(l);
        }).on("hide.bs.modal", function (t) {
