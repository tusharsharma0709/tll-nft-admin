...
var KTDefaultDatatableDemo = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 20, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !0, height: 550, footer: !1 }, sortable: !0, filterable: !1, pagination: !0, search: { input: $("#kt_datatable_search_query") }, rows: { autoHide: !1 }, columns: [{ field: "RecordID", title: "#", sortable: !1, width: 20, type: "number", selector: !1, textAlign: "center" }, { field: "OrderID", title: "Order ID" }, { field: "Country", title: "Country", template: function (t) {
        ...
        } }, { field: "CompanyEmail", title: "Email", width: 150 }, { field: "ShipAddress", title: "Ship Address", width: 200 }, { field: "ShipDate", title: "Ship Date", type: "date", format: "MM/DD/YYYY" }, { field: "CompanyName", title: "Company Name", width: 200 }, { field: "Status", title: "Status", template: function (t) {
