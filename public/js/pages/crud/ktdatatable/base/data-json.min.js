"use strict";
var KTDatatableJsonRemoteDemo = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: HOST_URL + "/api/?file=datatables/datasource/default.json", pageSize: 10 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, search: { input: $("#kt_datatable_search_query"), key: "generalSearch" }, columns: [{ field: "RecordID", title: "#", sortable: !1, width: 20, type: "number", selector: { class: "" }, textAlign: "center" }, { field: "OrderID", title: "Order ID" }, { field: "Country", title: "Country", template: function (t) {
        ...
        } }, { field: "Actions", title: "Actions", sortable: !1, width: 125, autoHide: !1, overflow: "visible", template: function () {
