"use strict";
var KTDatatableChildRemoteDataDemo = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/customers.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !1, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, detail: { title: "Load sub table", content: function (t) {
          $("<div/>").attr("id", "child_data_ajax_" + t.data.RecordID).appendTo(t.detailCell).KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/orders.php", params: { query: { generalSearch: "", CustomerID: t.data.RecordID } } } }, pageSize: 5, serverPaging: !0, serverFiltering: !1, serverSorting: !0 }, layout: { scroll: !1, footer: !1, spinner: { type: 1, theme: "default" } }, sortable: !0, columns: [{ field: "RecordID", title: "#", sortable: !1, width: 30 }, { field: "OrderID", title: "Order ID", template: function (t) {
                return "<span>" + t.OrderID + " - " + t.ShipCountry + "</span>";
              } }, { field: "ShipCountry", title: "Country", width: 100 }, { field: "ShipAddress", title: "Ship Address" }, { field: "ShipName", title: "Ship Name" }, { field: "TotalPayment", title: "Payment", type: "number" }, { field: "Status", title: "Status", template: function (t) {
          ...
          var e = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "success" } };return '<span class="label label-' + e[t.Type].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + e[t.Type].state + '">' + e[t.Type].title + "</span>";
        } }, { field: "Actions", width: 125, title: "Actions", sortable: !1, overflow: "visible", autoHide: !1, template: function () {
