"use strict";
var KTAppsProjectsListDatatable = { init: function () {
    $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, search: { input: $("#kt_subheader_search_form"), delay: 400, key: "generalSearch" }, columns: [{ field: "RecordID", title: "#", sortable: "asc", width: 40, type: "number", selector: !1, textAlign: "left", template: function (t) {
          ...
          var e = KTUtil.getRandomInt(1, 10),
              a = ["Angular, React", "Vue, Kendo", ".NET, Oracle, MySQL", "Node, SASS, Webpack", "MangoDB, Java", "HTML5, jQuery, CSS3", "React, Vue", "MangoDB, Node.js"];return e < 7 ? '<div class="d-flex align-items-center">\t\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-circle symbol-sm">\t\t\t\t\t\t\t\t\t<img class="" src="assets/media/project-logos/' + e + '.png" alt="photo"/>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="ml-3">\t\t\t\t\t\t\t\t\t<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + t.CompanyAgent + '</div>\t\t\t\t\t\t\t\t\t<a href="#" class="text-muted font-weight-bold text-hover-primary">' + a[e - 1] + "</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>" : '<div class="d-flex align-items-center">\t\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-circle symbol-light-' + ["success", "primary", "danger", "success", "warning", "dark", "primary", "info"][KTUtil.getRandomInt(0, 7)] + '">\t\t\t\t\t\t\t\t\t<span class="symbol-label font-size-h4">' + t.CompanyAgent.substring(0, 1) + '</span>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<div class="ml-3">\t\t\t\t\t\t\t\t\t<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + t.CompanyAgent + '</div>\t\t\t\t\t\t\t\t\t<a href="#" class="text-muted font-weight-bold text-hover-primary">' + a[e - 4] + "</a>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t</div>";
        } }, { field: "Country", title: "Country", template: function (t) {
          var e = "";return e += '<div class="font-weight-bolder font-size-lg mb-0">' + t.Country + "</div>", e += '<div class="font-weight-bold text-muted">Code: ' + t.ShipCountry + "</div>";
        } }, { field: "ShipDate", title: "Ship Date", type: "date", format: "MM/DD/YYYY", template: function (t) {
          var e = "",
              a = KTUtil.getRandomInt(1, 4);return e += '<div class="font-weight-bolder text-primary mb-0">' + t.ShipDate + "</div>", e += '<div class="text-muted">' + { 1: { title: "Paid", class: " label-light-primary" }, 2: { title: "Approved", class: " label-light-danger" }, 3: { title: "Pending", class: " label-light-primary" }, 4: { title: "Rejected", class: " label-light-success" } }[a].title + "</div>";
        } }, { field: "CompanyName", title: "Company Name", template: function (t) {
          var e = "";return e += '<div class="font-weight-bold text-muted">' + t.CompanyName + "</div>";
