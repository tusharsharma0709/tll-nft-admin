"use strict";
var KTEcommerceMyOrders = { init: function () {
    var a;a = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php", map: function (a) {
              var e = a;return void 0 !== a.data && (e = a.data), e;
            } } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, search: { input: $("#kt_datatable_search_query"), key: "generalSearch" }, columns: [{ field: "Product", title: "Product", sortable: "asc", width: 160, template: function (a) {
          var e = KTUtil.getRandomInt(1, 15);return '<div class="d-flex align-items-center">                        <div class="symbol symbol-50 symbol-sm flex-shrink-0">                            <div class="symbol-label">                                <img class="h-75 align-self-end" src="assets/media/products/' + e + '.png" alt="photo"/>                            </div>                        </div>                        <div class="ml-4">                            <a href="#" class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + ["Smartwatch", "Headphones", "Sneakers", "Mobile Device", "Running Shoes", "Bicycle", "Fashion", "Stylish Belt", "Smartwatch", "Headphones", "Sneakers", "Mobile Device", "Running Shoes", "Bicycle", "Fashion", "Mobile Device"][e] + "</a>                        </div>                    </div>";
        } }, { field: "OrderID", title: "Order ID" }, { field: "ShipDate", title: "Ship Date", type: "date", format: "MM/DD/YYYY" }, { field: "Status", title: "Status", template: function (a) {
          var e = { 1: { title: "Pending", class: " label-light-success" }, 2: { title: "Delivered", class: " label-light-danger" }, 3: { title: "Canceled", class: " label-light-primary" }, 4: { title: "Success", class: " label-light-success" }, 5: { title: "Info", class: " label-light-info" }, 6: { title: "Danger", class: " label-light-danger" }, 7: { title: "Warning", class: " label-light-warning" } };return '<span class="label font-weight-bold label-lg ' + e[a.Status].class + ' label-inline">' + e[a.Status].title + "</span>";
        } }, { field: "Type", title: "Type", autoHide: !1, template: function (a) {
          var e = { 1: { title: "Online", state: "danger" }, 2: { title: "Retail", state: "primary" }, 3: { title: "Direct", state: "success" } };return '<span class="label label-' + e[a.Type].state + ' label-dot mr-2"></span><span class="font-weight-bold text-' + e[a.Type].state + '">' + e[a.Type].title + "</span>";
