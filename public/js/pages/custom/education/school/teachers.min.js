...
var KTAppsEducationSchoolTeacher = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, columns: [{ field: "CompanyName", title: "Teacher", width: 250, template: function (t) {
          var a = "300_" + KTUtil.getRandomInt(1, 20) + ".jpg",
              e = KTUtil.getRandomInt(1, 5);return '<div class="d-flex align-items-center">\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-sm flex-shrink-0">\t\t\t\t\t\t\t\t<img class="" src="assets/media/users/' + a + '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="ml-4">\t\t\t\t\t\t\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' + t.CompanyAgent + '</a>\t\t\t\t\t\t\t\t<div class="text-muted font-weight-bold">' + { 1: { title: "Mathematics, BA" }, 2: { title: "Geography, BSc" }, 3: { title: "History, PhD" }, 4: { title: "Physics, MS" }, 5: { title: "astronomy, MA" } }[e].title + "</div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>";
        } }, { field: "CompanyAgent", title: "Department", template: function (t) {
          var a = "";return a += '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + t.CompanyName + "</a>";
        } }, { field: "JoinedDate", title: "Joined", type: "date", width: 100, format: "MM/DD/YYYY", template: function (t) {
          var a = "";return a += '<div class="font-weight-bolder text-primary mb-0">' + t.ShipDate + "</div>";
        } }, { field: "Status", title: "Status", autoHide: !1, width: 100, template: function (t) {
          var a = KTUtil.getRandomInt(1, 3),
              e = { 1: { title: "New", class: " label-light-primary" }, 2: { title: "Active", class: " label-light-danger" }, 3: { title: "In-active", class: " label-light-info" } };return '<span class="label label-lg font-weight-bold ' + e[a].class + ' label-inline">' + e[a].title + "</span>";
