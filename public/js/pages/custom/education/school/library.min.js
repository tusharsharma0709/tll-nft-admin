"use strict";
var KTAppsEducationSchoolLibrary = { init: function () {
    var t;t = $("#kt_datatable").KTDatatable({ data: { type: "remote", source: { read: { url: HOST_URL + "/api/datatables/demos/default.php" } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { scroll: !1, footer: !1 }, sortable: !0, pagination: !0, columns: [{ field: "CompanyName", title: "Book", width: 250, template: function (t) {
          var a = KTUtil.getRandomInt(1, 13) + ".png",
              i = KTUtil.getRandomInt(1, 4);return '<div class="d-flex align-items-center">\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-sm flex-shrink-0">\t\t\t\t\t\t\t\t<img class="" src="assets/media/books/' + a + '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="ml-4">\t\t\t\t\t\t\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' + t.CompanyName + '</a>\t\t\t\t\t\t\t\t<div class="text-muted font-weight-bold">' + { 1: { title: "Fiction" }, 2: { title: "Drama" }, 3: { title: "Classic" }, 4: { title: "Thriller" } }[i].title + "</div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>";
        } }, { field: "CompanyAgent", title: "Author", template: function (t) {
          var a = "";return a += '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + t.CompanyAgent + "</a>";
        } }, { field: "IssueDate", title: "Issued", type: "date", width: 100, format: "MM/DD/YYYY", template: function (t) {
          var a = "",
              i = KTUtil.getRandomInt(1, 3);return a += '<div class="font-weight-bolder text-primary mb-0">' + t.ShipDate + "</div>", a += '<div class="text-muted">' + { 1: { title: "New", class: " label-light-primary" }, 2: { title: "Good", class: " label-light-danger" }, 3: { title: "Demaged", class: " label-light-primary" } }[i].title + "</div>";
        } }, { field: "Status", title: "Status", autoHide: !1, width: 100, template: function (t) {
          var a = KTUtil.getRandomInt(1, 4),
              i = { 1: { title: "Available", class: " label-light-primary" }, 2: { title: "In Use", class: " label-light-danger" }, 3: { title: "No Stock", class: " label-light-info" }, 4: { title: "Arriving", class: " label-light-success" } };return '<span class="label label-lg font-weight-bold ' + i[a].class + ' label-inline">' + i[a].title + "</span>";
        } }, { field: "Actions", title: "Actions", sortable: !1, width: 130, overflow: "visible", autoHide: !1, template: function () {
