"use strict";
var KTamChartsStockChartsDemo = { init: function () {
    var e, t, a, o, l;t = [], a = [], o = [], l = [], function () {
      var e = new Date();e.setDate(e.getDate() - 500), e.setHours(0, 0, 0, 0);for (var r = 0; r < 500; r++) {
        var i = new Date(e);i.setDate(i.getDate() + r);var d = Math.round(Math.random() * (40 + r)) + 100 + r,
