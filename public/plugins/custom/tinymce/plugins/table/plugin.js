...
(function (domGlobals) {
  ...
  var adt = Adt.generate([{ invalid: ['raw'] }, { pixels: ['value'] }, { percent: ['value'] }]);
  ...
  var adt$1 = Adt.generate([{ none: [] }, { only: ['index'] }, {
    left: ['index', 'next']
  }, {
  ...
  var adt$2 = Adt.generate([{ none: ['current'] }, { first: ['current'] }, {
  ...
  var adt$3 = Adt.generate([{ before: ['element'] }, {
    on: ['element', 'offset']
  }, { after: ['element'] }]);
  ...
  var adt$4 = Adt.generate([{ domRange: ['rng'] }, {
